import { t as Route } from "./routes-L09tIbzB.js";
import { useEffect, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useQuery } from "@tanstack/react-query";
import { Calendar, File, MapPin, Ticket } from "lucide-react";
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							}), /* @__PURE__ */ jsx("span", { children: formatDate(ticket.starts_at) })]
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(MapPin, {
								size: 16,
								className: "text-gray-400"
							}), /* @__PURE__ */ jsx("span", { children: ticket.venue_name })]
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(Ticket, {
								size: 16,
								className: "text-gray-400"
							}), /* @__PURE__ */ jsx("span", { children: soldOut ? "Sold out" : `${ticket.ticket_types[0].available} ticket${ticket.ticket_types[0].available === 1 ? "" : "s"} left` })]
						})
					]
				})
			] }),
...
var TicketsPage = () => {
	...
	if (isLoading) return /* @__PURE__ */ jsx("div", { children: "Tickets Loading ..." });
	if (error) return /* @__PURE__ */ jsx("div", { children: "Something went wrong" });
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(File, {}), /* @__PURE__ */ jsx("div", { children: "No tickets found" })]
			}) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
				className: "grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3",
				children: tickets?.map((ticket) => /* @__PURE__ */ jsx(TicketCard, {
					ticket,
					onBuy: handleBuy
				}, ticket.slug))
			}), selectedTicket && /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("p", {
							...
							children: ["You're about to buy ", /* @__PURE__ */ jsx("strong", { children: selectedTicket.title })]
						}),
						/* @__PURE__ */ jsxs("div", {
